...
async function getDashboardStats(userId: string, role: string) {
  if (role === 'SUPER_ADMIN') {
    const [totalAuthors, totalBooks, publishedBooks, draftBooks] =
      await Promise.all([
    ...
    const [totalBooks, publishedBooks, draftBooks, totalChapters] =
      await Promise.all([
        ...
        <CardHeader>
          {session.user.role === 'SUPER_ADMIN' ? (
            <>
              ...
              <CardDescription>
                Most recently updated books by Authors
              </CardDescription>
            </>
          ) : (
            <>
              ...
              <CardDescription>
                Your most recently updated books
              </CardDescription>
            </>
          )}
        </CardHeader>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-4 min-w-0 flex-1">
                      <div className="h-16 w-12 shrink-0 bg-linear-to-br from-blue-500 to-purple-600 rounded flex items-center justify-center text-white font-bold">
                        {book.title.charAt(0)}
                      </div>
